...
1.  **Side Vector**: Aligns Robot Tool **Z-Axis** with User's Hand Side (Pinky) direction.
2.  **Normal Vector**: Aligns Robot Tool **Y-Axis** with User's Palm Normal.
3.  **Approach Vector**: Aligns Robot Tool **X-Axis** with User's Index Finger (Forward).
